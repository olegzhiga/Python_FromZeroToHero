...
flag = True
resultOfInputNums = int(input())
resultOfSquareInputNums = resultOfInputNums*resultOfInputNums

while flag:
    if resultOfInputNums == 0:
        flag = False
    else:
        inputNums = int(input())
        resultOfInputNums += inputNums
        resultOfSquareInputNums += (inputNums*inputNums)

print(resultOfInputNums)
print(resultOfSquareInputNums)
